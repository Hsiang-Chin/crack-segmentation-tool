...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.track_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.track_display.setText("")
        self.track_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.cost_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.cost_display.setText("")
        self.cost_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.image_crop_down_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.image_crop_down_display.setText("")
        self.image_crop_down_display.setScaledContents(False)
        self.image_crop_down_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.middlepoint_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        ...
        self.wavelet_check_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.wavelet_check_display.setText("")
        self.wavelet_check_display.setScaledContents(False)
        self.wavelet_check_display.setAlignment(
        ...
        self.x_size_show.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.x_size_show.setMode(QtWidgets.QLCDNumber.Mode.Dec)
        self.x_size_show.setSegmentStyle(QtWidgets.QLCDNumber.SegmentStyle.Flat)
        ...
        self.y_size_show.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.y_size_show.setSegmentStyle(QtWidgets.QLCDNumber.SegmentStyle.Flat)
        ...
        self.edge_map_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.edge_map_display.setText("")
        self.edge_map_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.edge_tracks_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.edge_tracks_display.setText("")
        self.edge_tracks_display.setTextFormat(QtCore.Qt.TextFormat.PlainText)
        self.edge_tracks_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.all_segments_display.setFrameShape(QtWidgets.QFrame.Shape.Box)
        ...
        self.manual_segment_screen.setFrameShape(QtWidgets.QFrame.Shape.Box)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.folder_line_edit.setText(_translate("MainWindow", ""))
        ...
        self.filename_label_2.setText(_translate("MainWindow", ""))
        ...
        self.update_image_crop_button.setText(_translate("MainWindow", "Update cropped Image"))
        self.label_2.setText(_translate("MainWindow", "Color Channel"))
        ...
        self.wavelet_button.setText(_translate("MainWindow", "Check wavelet"))
